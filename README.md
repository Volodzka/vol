<h1 align="center" id="title">Blooket</h1>
...
<p>1. Copy and Paste this code into the Developer Console of Blookit;</p>
...
.cheat:hover {
    ...
    header.innerHTML = `Blooket Helper <span style="font-size: 0.6rem"></span>`;
    ...
    body.innerHTML = `<span id="curPageEl">${
        getSite(true)
            ...
            : "No game detected"
    }</span><br><span>(Press E to hide this menu)</span><br>`;
    ...
    footer.innerHTML = `<span>Benas was here :D<br>FSOCIETY`;
    ...
    let cheats = {
        ...
        cafe: {
            ...
            "Set Cash": () => {
                reactHandler().stateNode.setState({
                    cafeCash: Number(
                        parseFloat(prompt("How much cash would you like boi?"))
                    ),
                });
            },
        ...
        gold: {
            "Set Gold": () => {
                let gold = Number(
                    parseFloat(prompt("How much gold do you want cheater?"))
                );
    ...
    global.innerHTML = `<summary style="padding: 10px; font-size: 1.5em; font-weight: bolder">Cheats</summary>`;
